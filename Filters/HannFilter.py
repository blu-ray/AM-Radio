...
class HannFilter(BaseFilter):
    """
    Represents the Hann filter in the time domain. For more information, see the documents of the `BaseFilter`.
    """
